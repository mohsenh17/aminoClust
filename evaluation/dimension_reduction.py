...
def process_latents_for_tsne(model, dataloader, device, output_file, n_samples=3):
    model.eval()
    latents = []
    cluster_ids = []
    labels = []
...
if __name__ == "__main__":
    ...
    for i in range (2,21):
        ...
        process_latents_for_tsne(model, test_loader, device, output_file, n_samples=1000)
